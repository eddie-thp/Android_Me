...
public class BodyPartFragment extends Fragment {
    ...
    private static final String STATE_RESOURCES = "RESOURCES_STATE";
    private static final String STATE_RESOURCE_INDEX = "RESOURCE_INDEX_STATE";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(STATE_RESOURCES);
            mListIndex = savedInstanceState.getInt(STATE_RESOURCE_INDEX);
        }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putIntegerArrayList(STATE_RESOURCES, new ArrayList<Integer>(mImageIds));
        outState.putInt(STATE_RESOURCE_INDEX, mListIndex);
    }
}
