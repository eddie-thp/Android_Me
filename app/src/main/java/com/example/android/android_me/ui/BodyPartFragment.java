...
public class BodyPartFragment extends Fragment {
    ...
    public void setImageResourceIndex(int imageResourceIndex) {
        mImageResourceIndex = imageResourceIndex;
    }
...
//
        ...
        if (mImageResources != null && !mImageResources.isEmpty() && mImageResourceIndex >= 0 && mImageResourceIndex < mImageResources.size()) {
            imageView.setImageResource(mImageResources.get(mImageResourceIndex));
        }
